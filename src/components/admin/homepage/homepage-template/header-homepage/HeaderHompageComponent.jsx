                ...
                <nav className="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top">
                    ...
                    <ul className="navbar-nav ml-auto">
                        ...
                        <li className="nav-item dropdown no-arrow mx-1">
                            ...
                            {/* Dropdown - Alerts */}
                            <div className="dropdown-list dropdown-menu dropdown-menu-right animated--grow-in" aria-labelledby="alertsDropdown">
                        ...
                        <li className="nav-item dropdown no-arrow mx-1">
                            ...
                            {/* Dropdown - Messages */}
                            <div className="dropdown-list dropdown-menu dropdown-menu-right animated--grow-in" aria-labelledby="messagesDropdown">
                                <h6 className="dropdown-header">
                                    Message Center
                                </h6>
                                <a className="dropdown-item d-flex align-items-center" href="#">
